    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="font-fantasy text-3xl text-quest-cream mb-2">Welcome Back</h1>
          <p className="text-quest-cream/60">Sign in to continue your quest</p>
        </div>
        ...
        <Card>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-quest-charcoal text-quest-cream/40">or continue with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 text-quest-cream/60">
                <input type="checkbox" className="rounded border-quest-cream/20" />
                Remember me
              </label>
              <Link href="/auth/forgot-password" className="text-quest-gold hover:underline">
                Forgot password?
              </Link>
            </div>
          ...
          <p className="mt-6 text-center text-quest-cream/60 text-sm">
            ...
            <Link href="/auth/register" className="text-quest-gold hover:underline">
              Create one
            </Link>
          </p>
        </Card>
